...
class CustomImageDataset(Dataset):
    def __init__(self, data_file_path, desired_width, desired_height):
        ...
        self.data_list = load_dataset(data_file_path)['train']
    ...
    def __getitem__(self, idx):
        try:
            ...
            img = resize_and_pad(img, self.desired_width, self.desired_height)
            # hint = Image.open(self.data_list[idx]['ocr_result_rendered_image'])
            ocr_result_rendered_image = data_item['ocr_result_rendered_image']
            hint = revise_image(ocr_result_rendered_image)
